...
test_reward_filename = os.path.join(base_log_dir, 'New_hIGH08_August_rewards_whole_TestOnly.txt')
action_history_filename = os.path.join(base_log_dir, 'New_High_action_history_whole_TestOnly.txt')
...
def test(args,env, model):
    ...
    for epoch in range(args.test_epoch):
        ...
        with open(action_history_filename, "a") as file:
