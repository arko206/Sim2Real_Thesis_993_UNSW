...
class Ur5():
    ...
    def step(self,action, object_position):
        ...
        reward, terminal, target_pos, end_eff_pos = self.get_reward(object_position,position,rpy)
    ...
    def get_reward(self,object_position,pos,rpy):
        t = False
    ...
    def target_vis(self,goal):
        ...
        for row in [1]:
            for col in range(1):
                ...
                pose.position.x = origin_pose.position.x + 0.002
