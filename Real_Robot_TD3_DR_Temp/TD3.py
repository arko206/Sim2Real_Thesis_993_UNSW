...
class TD3(object):
    ...
    def choose_action(self, state, noise=True):
        ...
        return np.clip(action,-3.14,3.14)
    ...
    def Learn(self):
        ...
        a_ = torch.clamp(a_, min=-3.14, max=+3.14).detach()
    ...
    #ef load_model(self, actor_path, critic_path, optim_a_path, optim_c_path):
        #self.actor_target.load_state_dict(torch.load('/home/arka/newark_ws/src/Ur5_TD3/DRLMODELTD3TD3/31_07_2024/actor.pth'))
        #self.critic_target.load_state_dict(torch.load('/home/arka/newark_ws/src/Ur5_TD3/DRLMODELTD3TD3/31_07_2024/critic.pth'))
        #self.actor.load_state_dict(torch.load('/home/arka/newark_ws/src/Ur5_TD3/DRLMODELTD3TD3/31_07_2024/actor.pth'))
        #self.critic.load_state_dict(torch.load('/home/arka/newark_ws/src/Ur5_TD3/DRLMODELTD3TD3/31_07_2024/critc.pth'))
        #self.optim_a.load_state_dict(torch.load('/home/arka/newark_ws/src/Ur5_TD3/DRLMODELTD3TD3/31_07_2024/optim_a.pth'))
        #self.optim_c.load_state_dict(torch.load('/home/arka/newark_ws/src/Ur5_TD3/DRLMODELTD3TD3/31_07_2024/optim_c.pth'))
    ...
    def load_model(self, actor_path, critic_path, optim_a_path, optim_c_path):
        try:
            ...
            if os.path.exists(optim_a_path):
                self.optim_a.load_state_dict(torch.load(optim_a_path, map_location=device))
            ...
            if os.path.exists(optim_c_path):
                self.optim_c.load_state_dict(torch.load(optim_c_path, map_location=device))
