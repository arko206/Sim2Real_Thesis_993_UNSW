...
train_reward_filename = os.path.join(base_log_dir, 'TD311THAugust_training_rewards_whole.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_date', default='/10_08_2024')
    #Folder stored with trained model weights, which are used for transfer learning
    parser.add_argument('--model_date_', default='/10_08_2024')
