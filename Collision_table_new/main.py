...
joint_angles_filename = os.path.join(base_log_dir, '16th_Septemp_Joint_Angles_whole.txt')
rpy_filename = os.path.join(base_log_dir, '16th_Septempemp_RPY_whole.txt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_date', default='/14_09_2024')
    #Folder stored with trained model weights, which are used for transfer learning
    parser.add_argument('--model_date_', default='/14_09_2024')
